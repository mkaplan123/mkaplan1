...
echo -e "\t" `rpm -qi setup |grep Date:` >> $out_file_path
...
echo -e "\n\n========================================= DNS SERVER IP ===========================================\n" >> $out_file_path
domainname >> $out_file_path
 
echo -e "\n\n==================================== RUNNING SERVICE INFO ====================================\n" >> $out_file_path
systemctl list-units | grep running|sort >> $out_file_path

echo -e "\n\n========================================= SELINUX ===========================================\n" >> $out_file_path
cat /etc/selinux/config |grep SELINUX= >> $out_file_path
 
echo -e "\n\n==================================== TOTAL RUNNING SERVICE ===================================\n" >> $out_file_path
echo -e "\tTotal Running service:\t"`systemctl list-units | grep running|sort| wc -l` >> $out_file_path

echo -e "\n\n==================================== NON-RUNNING SERVICE INFO ====================================\n" >> $out_file_path
systemctl list-units | grep exited|sort >> $out_file_path
 
echo -e "\n\n==================================== TOTAL NON-RUNNING SERVICE ===================================\n" >> $out_file_path
echo -e "\tTotal Non-Running service:\t"`systemctl list-units | grep exited|sort| wc -l` >> $out_file_path
 
echo -e "\n\n========================================= GRUB INFO ==========================================\n" >> $out_file_path
cat /etc/default/grub >> $out_file_path

echo -e "\n\n========================================= TOTAL SYSTEM INSTALLED PACKAGES ==========================================\n" >> $out_file_path
echo -e "\tTotal System Installed Packages:\t"`yum list| more|wc -l` >> $out_file_path

echo -e "\n\n========================================= SYSTEM INSTALLED PACKAGES ==========================================\n" >> $out_file_path
yum list| more >> $out_file_path
